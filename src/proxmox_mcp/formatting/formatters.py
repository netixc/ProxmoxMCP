...
class ProxmoxFormatters:
    ...
    def format_uptime(seconds) -> str:
        ...
        Args:
            seconds: Uptime in seconds (int) or error message (str)
            
        Returns:
            Formatted uptime string
        """
        # Handle cases where seconds might be a string (permission errors)
        if isinstance(seconds, str):
            return f"{ProxmoxTheme.METRICS['uptime']} {seconds}"
